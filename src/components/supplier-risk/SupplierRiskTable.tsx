...
type SortKey = 'supplierName' | 'location' | 'financialRiskScore' | 'inherentRiskScore' | 'integratedRiskScore' | 'lastUpdated';
    ...
    <Card>
      <CardHeader className="gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
          <Input placeholder="Search supplier, location, incident" value={query} onChange={(e) => setQuery(e.target.value)} />
