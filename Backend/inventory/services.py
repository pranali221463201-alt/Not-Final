...
try:
    ...
    print("[OK] Inventory: Supplier risk predictor loaded successfully")
except Exception as e:
    print(f"[WARN] Inventory: Could not load supplier risk predictor: {e}")
    _predictor = None
...
def get_supplier_risk_level(supplier_name: str) -> str:
    ...
    try:
        ...
        print(f"[WARN] Could not fetch risk for supplier '{supplier_name}': {e}")
